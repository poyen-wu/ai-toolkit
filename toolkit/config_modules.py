...
class SaveConfig:
    def __init__(self, **kwargs):
        ...
        self.load_rng_state: bool = kwargs.get("load_rng_state", True)
...
class SampleConfig:
    def __init__(self, **kwargs):
        ...
        self.ext: ImgExt = kwargs.get('format', 'png')
...
class TrainConfig:
    def __init__(self, **kwargs):
        ...
        self.do_scheduled_differential_guidance = kwargs.get('do_scheduled_differential_guidance', False)
